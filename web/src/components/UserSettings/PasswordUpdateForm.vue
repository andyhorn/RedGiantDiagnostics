    ...
    <div class="container">
        <b-form @submit.prevent="onSubmit" @reset="onReset" @keydown.enter="$event.stopPropagation">
            <div v-if="requiresCurrentPassword">
                ...
                <div class="row">
                    <div class="col-10">
                        <b-input id="current-password-input" 
            ...
            <div class="row">
                <div class="col-10">
                    <b-input id="new-password-input" 
                        type="password" required v-model="newPassword"
                        @keydown.enter="$event.stopPropagation" />
                </div>
            </div>
            <div class="row mt-3">
            ...
            <div class="row">
                <div class="col-10">
                    <b-input id="password-confirm-input" 
                        type="password" required v-model="confirmNewPassword"
                        @keydown.enter="$event.stopPropagation" />
                </div>
                <div class="col-2">
